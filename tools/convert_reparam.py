...
def parse_args():
    ...
    parser.add_argument('--work-dir', default='work_dirs/temp/', help='the dir to save logs and models')
    parser.add_argument(
...
def main():
    ...
    cpt = torch.load(cfg.resume_from)
    load_state_dict(model, cpt['state_dict'])
    ...
    save_path = cfg.resume_from.split('.pth')[0] + '_reparam.pth'
