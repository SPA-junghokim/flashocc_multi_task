...
model = dict(
    ...
    frustum_depth_attr='reverse_transmittance',
    frustum_depth_residual=True,
    frustum_to_voxel=dict(
        ...
        mode='bilinear', 
        padding_mode='zeros',
        depth_mode="UD", # UD, SID, LID -> viewtransform 과 동일하게 UD 로 사용
    ),
    
    occ_head=dict(
        type='BEVOCCHead3D',
        in_dim=numC_Trans_voxelhead,
        out_dim=32,
        use_mask=True,
        num_classes=18,
        use_predicter=True,
