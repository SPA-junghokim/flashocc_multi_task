...
# ===> bus - IoU = 25.41
# ===> car - IoU = 38.11
# ===> construction_vehicle - IoU = 9.7
# ===> motorcycle - IoU = 5.24
# ===> pedestrian - IoU = 12.74
# ===> traffic_cone - IoU = 8.94
# ===> trailer - IoU = 16.07
# ===> truck - IoU = 21.48
# ===> driveable_surface - IoU = 77.48
# ===> other_flat - IoU = 35.62
# ===> sidewalk - IoU = 44.68
# ===> terrain - IoU = 49.55
# ===> manmade - IoU = 36.6
# ===> vegetation - IoU = 30.32
# ===> mIoU of 6019 samples: 26.37