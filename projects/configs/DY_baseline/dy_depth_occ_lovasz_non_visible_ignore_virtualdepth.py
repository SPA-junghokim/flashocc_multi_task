...
# ===> bus - IoU = 43.55
# ===> car - IoU = 45.12
# ===> construction_vehicle - IoU = 15.66
# ===> motorcycle - IoU = 15.27
# ===> pedestrian - IoU = 17.01
# ===> traffic_cone - IoU = 8.84
# ===> trailer - IoU = 27.27
# ===> truck - IoU = 32.83
# ===> driveable_surface - IoU = 78.36
# ===> other_flat - IoU = 40.93
# ===> sidewalk - IoU = 48.24
# ===> terrain - IoU = 52.4
# ===> manmade - IoU = 38.17
# ===> vegetation - IoU = 32.08
# ===> mIoU of 6019 samples: 32.57